...
```{r}
#THIS DOCUMENT KNITS TO A PDF. TO DO THIS, YOU NEED TO INSTALL LATEX BEFORE KNITTING. TO DO SO, JUST RUN THE FOLLOWING 2 COMMANDS ON YOUR R CONSOLE:
...
if (!tinytex::is_tinytex()) {
  cat("**WARNING:** You need to install TinyTeX to knit this document to PDF. Run this in your R console:  
r
install.packages('tinytex')  
tinytex::install_tinytex()  
")
